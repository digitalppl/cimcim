...
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("main_logo1") ) : ?>
<?php endif; ?>
</div>
<div id="header-logo-image">
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("main_logo2") ) : ?>
<?php endif; ?>
</div>
<div id="header-logo-image">
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("main_logo3") ) : ?>
<?php endif; ?>
</div>
<div id="header-logo-image">
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("main_logo4") ) : ?>
<?php endif; ?>
</div>
...
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("engrus") ) : ?>
<?php endif; ?>
</div>
			</div><!-- .inner-wrap -->
...
<div style="background: rgba(0, 0, 50, 0.6); color: #fff; font-size: 22px; line-height:25px; ">
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("header_home1") ) : ?>
<?php endif; ?>
<div style="padding: 12px 12px 1px 12px; text-align:center;">
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("header_kod1") ) : ?>
<?php endif; ?>
</div>
